...
Each replica of a function keeps running for at least `idleTimeoutMs` millseconds if this is specified
...
topic partitions exceeds 3, and keeps each replica running for at least 60 seconds.
